...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO ratings VALUES ('', '3','$year', '$month', '$day', '$email','$rating', '" . addslashes($comment) . "', 'Novelle', '$date', '$ip','$ips','$feedback1','$feedback2','$feedback3','$feedback4','$feedback5','$feedback6','$feedback7','$feedback8')";

    $i = "SELECT ipdatename from ratings where ipdatename = '$ips'";
    $ii = mysqli_query($conn, $i);

    if (mysqli_num_rows($ii) > 0) {
        echo "<script> alert('You already submitted review for Novelle today. Thank you!'); window.location.href='thank.php';</script>";
    } else {
        ...
        <div class="whole">
            ...
            <form name="form1" method="POST">
                <div class="col-sm-12">
                    ...
                    <div class="headline">
                        <h2>How satisfied were you with the assistance provided by Novelle?</h2>
                    </div>
                ...
                <hr>
                <div class="headline3">
                    <h2>Do you have any feedback or suggestions for Novelle?</h2>
                </div>
                <div class="comments">
